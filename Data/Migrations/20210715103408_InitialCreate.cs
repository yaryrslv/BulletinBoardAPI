    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Number = table.Column<int>(type: "int", maxLength: 512, nullable: false, defaultValueSql: "NEXT VALUE FOR DBSequence"),
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(1048)", maxLength: 1048, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "fab4fac1-c546-41de-aebc-a14da6895711", "0", "Admin", "Admin" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "c7b013f0-5201-4317-abd8-c211f91b7330", "1", "User", "User" });
